...
export class I18n {
  private static messages: Record<string, Record<string, string>> = {
    en: {
      ...
      'error.repositoryNotFound': 'Unable to find the selected Git repository',
      'error.customPromptRead': 'Unable to read custom prompt file "{0}": {1}',
    ...
    'zh-cn': {
      ...
      'error.repositoryNotFound': '无法找到所选的 Git 仓库',
      'error.customPromptRead': '无法读取自定义提示词文件“{0}”：{1}',
